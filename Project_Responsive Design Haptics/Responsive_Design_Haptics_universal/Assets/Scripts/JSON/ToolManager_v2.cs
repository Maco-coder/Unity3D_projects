...
public class ToolManager : MonoBehaviour 
{
    ...
    void Start()
    {
        ...
        JSONstring = File.ReadAllText("./Assets/Scripts/JSON/TOOL_Haptic_style_sheet.json") ;
        ...
        {
            Debug.Log("ToolManager for object " + object_carabao.name + " starting script with id " + script["id"]);
            StartScript(script);
        }
        ...
        {
            Debug.Log("ToolManager for object " + object_carabao.name + " starting collider with id " + collider["id"]);
        ...
        {
            Debug.Log("ToolManager for object " + object_carabao.name + " starting constraint with id " + constraint["id"]);
    ...
    void StartScript(JsonData script)
    {
        ...
        try
        {
            ...
            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set " + script["id"] + " to " + (bool) script["enabled"]);
        }
        catch (Exception e)
        {
            Debug.LogError("ToolManager for object " + object_carabao.name + " could not enable/disable the script " + script["id"]);
        }
        ...
        try
        {
            ...
            Debug.Log("ToolManager for object " + object_carabao.name + " created a parameter dictionary for script " + script["id"]);
            if ((bool) script["enabled"])
            {
                // Loop through the parameters in the metrics object
                var metrics_dictionary = script["metrics"];
                Debug.Log("ToolManager for object " + object_carabao.name + " created dictionary object from the JSON files");
                foreach (var key in metrics_dictionary.Keys)
                {
                    Debug.Log("ToolManager for object " + object_carabao.name + " setting parameter " + (string) key + " to " + (string) metrics_dictionary[key]);
                ...
                Debug.Log("ToolManager for object " + object_carabao.name + " set the parameters for script " + script["id"]);
            }
        }
        catch (Exception e)
        {
            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to pass parameters for script " + script["id"]);
            Debug.LogError(e);
        }
    ...
    void StartCollider(JsonData collider)
    {
        ...
        try
        {
            ...
            Debug.Log("ToolManager for object " + object_carabao.name + " found collider object named " + collider["id"]);
            colliderObject.SetActive((bool) collider["enabled"]);
        }
        catch (Exception e)
        {
            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to enable/disable the collider object named " + collider["id"]);
        }
        ...
        try
        {
            ...
            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set position for collider with id: " + collider["id"]);
        }
        catch (Exception e)
        {
            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to set position for collider with id: " + collider["id"]);
        }
        ...
        try
        {
            ...
            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set rotation for collider with id: " + collider["id"]);
        }
        catch (Exception e)
        {
            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to set rotation for collider with id: " + collider["id"]);
        }
        ...
        try
        {
            ...
            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set scale for collider with id: " + collider["id"]);
        }
        catch (Exception e)
        {
            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to set scale for collider with id: " + collider["id"]);
        }
        ...
        if (selected_device == "stylus")
        {
                ...
                switch((string) collider["metrics"]["feedback-type"])
                {
                    case "friction": 
                        ...
                        try
                        {
                            ...
                            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set friction feedback parameters for " + collider["id"]);
                        }
                        catch (Exception e)
                        {
                            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to set friction feedback parameters for " + collider["id"]);
                        }
                        break;
                    case "spring":
                        ...
                        try
                        {
                            ...
                            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set spring feedback parameters for " + collider["id"]);
                        }
                        catch (Exception e)
                        {
                            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to set spring feedback parameters for " + collider["id"]);
                        }
                        break;
                    case "vibrate":
                        ...
                        try
                        {
                            ...
                            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set vibration parameters for " + collider["id"])
                        }
                        catch (Exception e)
                        {
                            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to set vibration parameters for " + collider["id"]);
                        }
                        break;
                    case "viscous":
                        ...
                        try
                        {
                            ...
                            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set viscosity parameters for " + collider["id"]);
                        }
                        catch (Exception e)
                        {
                            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to set viscosity parameters for " + collider["id"]);
                        }
                        break;
                    case "constant":
                        ...
                        try
                        {
                            ...
                            Debug.Log("ToolManager for object " + object_carabao.name + " successfully set constant haptic feedback parameters for " + collider["id"]);
                        }
                        catch (Exception e)
                        {
                            Debug.LogError("ToolManager for object " + object_carabao.name + " failed to set constant haptic feedback parameters for " + collider["id"]);
                        }
                        break;
                }
            }
            ...
            {
                Debug.LogError("ToolManager for object " + object_carabao.name + " failed to find a valid configuration for haptic effects for collider with id: " + collider["id"]);
            }
        }
        ...
        if (selected_device == "vr_controller")
        {
            try
            {
                ...
                Debug.Log("ToolManager for object " + object_carabao.name + " successfully assigned amplitude, frequency for collider " + collider["id"]);
            }
            catch (Exception e)
            {
                Debug.LogError("ToolManager for object " + object_carabao.name + " failed to find a valid configuration for haptic feedback for collider " + collider["id"]);
            }
        }
    }
        ...
        if (! (bool) constraint["enabled"])
        {
            switch(constraint["id"])
            {
                case "SpringJoint":
                    ...
                    Debug.Log("ToolManager for object " + object_carabao.name + " disabled SpringJoint");
                    break;
            }
            return;
        }
        try
        {
            switch ((string) constraint["metrics"]["constraint-type"])
            {
                case "SpringJoint":
                    ...
                    Debug.Log("ToolManager for object " + object_carabao.name + " successfully set SpringJoint parameters");
                    break;
            }
        }
        catch (Exception e)
        {
            Debug.Log("ToolManager for object " + object_carabao.name + " encountered an error while initializing constraint with id: " + constraint["id"]);
        }
    }
